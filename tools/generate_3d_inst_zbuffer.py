...
if __name__ == "__main__":
    ...
    # Multiprocess logger
    if os.path.exists("tracker_lifted_zb_stpls3d.txt") == False:
        with open("tracker_lifted_zb_stpls3d.txt", "w") as file:
    ...
    with torch.cuda.amp.autocast(enabled=cfg.fp16):
        ...
        for scene_id in tqdm(scene_ids):
            ...
            path = scene_id + ".pth"
            with open("tracker_lifted_zb_stpls3d.txt", "r") as file:
