...
def main():
    ...
    lift_cam = 10  # Vertical lift of the camera (increase to lift the camera higher)
    zoomout = 0.3  # Zoom out factor to view the scene with a wider angle
    ...
    snap_module = Snap(image_size, adjust_camera, save_folder="global_lift10_zoom0.3")
